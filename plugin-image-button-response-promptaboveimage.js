var jsPsychImageButtonResponsePromptAboveImage = (function (jspsych) {
  'use strict';

  var _package = {
    name: "@jspsych/plugin-image-button-response",
    version: "2.0.0",
    description: "jsPsych plugin for displaying a stimulus and getting a button response. Prompt above buttons, edited by KS.",
    type: "module",
    main: "dist/index.cjs",
    exports: {
  ...
  const info = {
    name: "image-button-response-promptaboveimage",
  ...
  class ImageButtonResponsePromptAboveImagePlugin {
    constructor(jsPsych) {
    ...
    trial(display_element, trial) {
      ...
      if (trial.prompt1 !== null) {
        ...
        var prompt_p1 = document.createElement('p'); 
        prompt_p1.innerHTML = trial.prompt1; 
        display_element.insertBefore(prompt_p1, null); 
      }
      let stimulusElement;
      let canvas;
      ...
      if (trial.prompt2 !== null) {
        //display_element.insertAdjacentHTML("beforeend", trial.prompt);
        var prompt_p2 = document.createElement('p'); 
        prompt_p2.innerHTML = trial.prompt2; 
        display_element.insertBefore(prompt_p2, null); 
      }
  ...
  return ImageButtonResponsePromptAboveImagePlugin;
